...
let Verbe = ["danse", "pleure", "chante", "se touche", "se trémousse", "eternue", "vomit", "découpe des gens", "tue son père", "se fait exploser", "mange ses godasses", "cherche des emmerdes", "se caresse les orteils", "frappe dans l'eau", "mange des enfants", "pète", "crie Allahu Akbar", "tond le gazon", "dégomme un poney", "crache sur tout le monde", "rit aux éclats", "tombe en dépression", "se casse le bras", "mange un string", "éclate ses boutons", "expédie ses ennemis en enfer", "chie par terre", "vomit"];
let Cod = ["d'une étrange manière", "de façon éronée", "bruyamment", "doucement", "fermement", "avec conviction", "sans aucune forme de pitié", "en toute impunité", "de façon indigne", "tout en délicatesse", "le sourire aux lèvres", "de manière hasardeuse", "avec hésitation", "comme un.e pro", "comme une merde", "comme un.e psychopathe", "avec les larmes aux yeux", "et s'envole vers d'autres cieux", "et disparaît dans un nuage de fumée", "puis décapite ses ennemis", "lentement mais sûrement", "puis se fait arrêter par Alexandre Benalla", "et se lave les mains", "et élimine son interlocueur", "et se téléporte en Antarctique", "et hurle comme un.e taré.é", "et monte au paradis"];
